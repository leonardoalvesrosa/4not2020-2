...
const AnuncioProd = require('../models/AnuncioProd');
...
controller.novo = async (req, res) => {
    ...
    try {
        await AnuncioProd.create(req.body);
        // HTTP 201: Created
        res.status(201).end();
    }
    catch(erro) {
...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await AnuncioProd.find()
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await AnuncioProd.findById(id)
...
controller.atualizar = async (req, res) => {
   try {
    ...
    let ret = await AnuncioProd.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await AnuncioProd.findByIdAndDelete(id)
